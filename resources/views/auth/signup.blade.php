...
<head>
  ...
  <meta name="description" content="Create your free CamboTrips account and start your Cambodia adventure." />
...
<body>
  ...
  <div class="auth-card">
    ...
    <p class="auth-subtitle">Join CamboTrips and start your Cambodia adventure</p>
    ...
    <form action="{{ route('signup') }}" method="POST" novalidate>
      ...
      <div class="form-group">
        ...
        @error('password')
          <p class="form-error">{{ $message }}</p>
        @enderror
        <p class="strength-hint">Use at least 6 characters with a mix of letters and numbers.</p>
      </div>
